...
const u16 gMetatiles_CelebiShrine[] = INCBIN_U16("data/tilesets/secondary/celebi_shrine/metatiles.bin");
const u16 gMetatileAttributes_CelebiShrine[] = INCBIN_U16("data/tilesets/secondary/celebi_shrine/metatile_attributes.bin");
