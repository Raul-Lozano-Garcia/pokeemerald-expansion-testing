...
const struct Tileset gTileset_CelebiShrine =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CelebiShrine,
    .palettes = gTilesetPalettes_CelebiShrine,
    .metatiles = gMetatiles_CelebiShrine,
    .metatileAttributes = gMetatileAttributes_CelebiShrine,
    .callback = NULL,
};
