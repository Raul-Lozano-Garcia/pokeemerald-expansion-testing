...
const u32 gItemIcon_LovrinaMachine[] = INCBIN_U32("graphics/items/icons/lovrina_machine.4bpp.lz");
const u32 gItemIconPalette_LovrinaMachine[] = INCBIN_U32("graphics/items/icon_palettes/lovrina_machine.gbapal.lz");
