...
const u32 gTrainerFrontPic_Mewris[] = INCBIN_U32("graphics/trainers/front_pics/mewris.4bpp.lz");
const u32 gTrainerPalette_Mewris[] = INCBIN_U32("graphics/trainers/front_pics/mewris.gbapal.lz");
