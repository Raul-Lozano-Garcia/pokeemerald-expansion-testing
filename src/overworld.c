...
void StoreInitialPlayerAvatarState(void)
{
    ...
    else if (TestPlayerAvatarFlags(PLAYER_AVATAR_FLAG_UNI_BIKE))
        sInitialPlayerAvatarState.transitionFlags = PLAYER_AVATAR_FLAG_UNI_BIKE;
...
static u8 GetAdjustedInitialTransitionFlags(struct InitialPlayerAvatarState *playerStruct, u16 metatileBehavior, u8 mapType)
{
    ...
    else if (playerStruct->transitionFlags != PLAYER_AVATAR_FLAG_UNI_BIKE)
        return PLAYER_AVATAR_FLAG_ON_FOOT;
    else
        return PLAYER_AVATAR_FLAG_UNI_BIKE;
}
