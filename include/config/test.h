...
#undef P_PIKACHU_AND_EEVEE_PARTNER_FORMS 
#define P_PIKACHU_AND_EEVEE_PARTNER_FORMS TRUE
#undef P_PICHU_SPIKY_EARED_FORM
#define P_PICHU_SPIKY_EARED_FORM         TRUE
