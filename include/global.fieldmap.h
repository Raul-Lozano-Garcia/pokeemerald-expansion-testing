...
#define PLAYER_AVATAR_FLAG_UNI_BIKE     (1 << 2)
...
#define PLAYER_AVATAR_FLAG_BIKE        (PLAYER_AVATAR_FLAG_MACH_BIKE | PLAYER_AVATAR_FLAG_UNI_BIKE)
...
enum
{
    UNI_BIKE_NORMAL,
    UNI_BIKE_TURNING,
    UNI_BIKE_WHEELIE_STANDING,
    UNI_BIKE_BUNNY_HOP,
    UNI_BIKE_WHEELIE_MOVING,
    UNI_BIKE_STATE5,
    UNI_BIKE_STATE6,
};
