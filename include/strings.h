...
extern const u8 gText_KissPoster10BP[];
extern const u8 gText_KissCushion10BP[];
extern const u8 gText_SmoochumDoll10BP[];
extern const u8 gText_TogepiDoll10BP[];
extern const u8 gText_MeowthDoll10BP[];
extern const u8 gText_ClefairyDoll10BP[];
extern const u8 gText_DittoDoll10BP[];
extern const u8 gText_CyndaquilDoll10BP[];
extern const u8 gText_ChikoritaDoll10BP[];
extern const u8 gText_TotodileDoll10BP[];

extern const u8 gText_LaprasDoll10BP[];
extern const u8 gText_SnorlaxDoll10BP[];
extern const u8 gText_VenusaurDoll10BP[];
extern const u8 gText_CharizardDoll10BP[];
extern const u8 gText_BlastoiseDoll10BP[];

extern const u8 gText_HealthMochi5BP[];
extern const u8 gText_MuscleMochi5BP[];
extern const u8 gText_ResistMochi5BP[];
extern const u8 gText_GeniusMochi5BP[];
extern const u8 gText_CleverMochi5BP[];
extern const u8 gText_SwiftMochi5BP[];
extern const u8 gText_FreshStartMochi15BP[];
extern const u8 gText_BottleCap5BP[];
extern const u8 gText_GoldBottleCap15BP[];
extern const u8 gText_AbilityCapsule10BP[];
...
extern const u8 gText_Leftovers10BP[];
extern const u8 gText_WhiteHerb10BP[];
extern const u8 gText_QuickClaw10BP[];
extern const u8 gText_MentalHerb10BP[];
extern const u8 gText_BrightPowder10BP[];
extern const u8 gText_ChoiceBand10BP[];
extern const u8 gText_ChoiceSpecs10BP[];
...
extern const u8 gText_Softboiled10BP[];
extern const u8 gText_SeismicToss24BP[];
extern const u8 gText_DreamEater24BP[];
extern const u8 gText_MegaPunch24BP[];
extern const u8 gText_MegaKick10BP[];
extern const u8 gText_BodySlam10BP[];
extern const u8 gText_RockSlide10BP[];
extern const u8 gText_Counter10BP[];
extern const u8 gText_ThunderWave10BP[];
extern const u8 gText_SwordsDance10BP[];
extern const u8 gText_DefenseCurl10BP[];
extern const u8 gText_Snore24BP[];
extern const u8 gText_MudSlap24BP[];
extern const u8 gText_Swift24BP[];
extern const u8 gText_IcyWind24BP[];
extern const u8 gText_Endure10BP[];
extern const u8 gText_PsychUp10BP[];
extern const u8 gText_IcePunch10BP[];
extern const u8 gText_ThunderPunch10BP[];
extern const u8 gText_FirePunch10BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FreshStartMochiDesc[];
...
extern const u8 gText_ExpSCandy[];
extern const u8 gText_ExpMCandy[];
extern const u8 gText_ExpLCandy[];
extern const u8 gText_ExpXLCandy[];
extern const u8 gText_ExpMaxCandy[];
...
extern const u8 gText_ThrowInLuxuryBalls[];
...
extern const u8 gText_ToMakeYourWish[];
